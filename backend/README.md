...
## Project Structure
    ...
    ├── testapiautostoryboa_64151  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_64151`
...
2. Clone this repo and `cd testapiautostoryboa_64151`
